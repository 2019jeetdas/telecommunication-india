...
#-----(10-B) data analysis of Urban-Telephone-2002-2012 -----
...
df = pd.read_csv ('/home/jeet/Desktop/No_Telephone_Lines_urban_during_2002-2012.csv',encoding="cp1252")
print("\n------- output data :-----------\n")
print("Urban telephone line data analysis:")
print("\n-----------------------------------\n")
...
plt.title('plot - 1 : Number of urban telephone lines in India [2002-2012]')
plt.xlabel("regions --- >")
plt.ylabel("Numbers --- >")
...
plt.title('plot - 2 : Number of urban telephone lines in India [2002-2012]')
plt.xlabel("regions --- >")
plt.ylabel("Numbers --- >")
